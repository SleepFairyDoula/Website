...
<main role="main">
	<div id="toptop" class="row">
		<img src="media/img1.jpg" class="top-pic">
		<div id="call">
			<h1>BE FREE TO FOCUS ON THEM</h1>
			<h2>The Most Important Thing You'll Do</h2>
		</div>
	</div>
	<div class="row divide">
		<h3>Bring your baby into the world with all your love plus some</h3>
	</div>
	<div class="row">
		<div class="box-pic box-back">
			<div class="box-content box-pic">
				<img src="media/img7.jpg">
			</div>
		</div>
		<div id="content" class="box-back text-center">
			...
			<div class="section">
				<img src="media/img2.jpg" class="left-pic">
